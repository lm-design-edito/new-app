...
class StopMotion extends Component<Props, {}> {
  ...
  componentDidUpdate(prevProps: Props): void {
    ...
    const hasPrevWidth = prevProps.width !== null
    const hasWidth = this.props.width !== null
    const widthHasChanged = prevProps.width !== this.props.width
    if (hasPrevWidth && hasWidth && widthHasChanged) this.setCanvasSize()

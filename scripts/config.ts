...
export enum Bucket {
  ...
  V1_GLITCHY = 'gs://decodeurs/design-edito/v1.glitchy'
}
...
export const bucketsMetadataMap = new Map<Bucket, BucketMetaData>([
  ...
  [Bucket.V1_FUEGO, {
    publicUrl: 'https://assets-decodeurs.lemonde.fr/design-edito/v1.fuego',
  ...
  [Bucket.V1_GLITCHY, {
    publicUrl: 'https://assets-decodeurs.lemonde.fr/design-edito/v1.glitchy',
    versionRange: '>=1.0.0-glitchy <=1.0.0-glitchy.999999999'
  }]
])
